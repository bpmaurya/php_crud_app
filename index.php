<!-- INSERT INTO `notes` (`sno`, `title`, `description`, `tstamp`) VALUES (NULL, 'second notes', 'this is my second notes', current_timestamp()); -->
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/crued_app/index.php/" method="POST">
    ...
    <?php
     if($insert){
       ...
       <p>success, you successfully inserted your notes.</p>
            </div>";
     }
    ?>
    <?php
     if($delete){
       echo "<div class='alert alert-success' role='alert'>
       <h4 class='alert-heading'>Congratulation!</h4>
       <p>success, you successfully deleted your notes.</p>
            </div>";
     }
    ?>
    <?php
     if($update){
       echo "<div class='alert alert-success' role='alert'>
       <h4 class='alert-heading'>Congratulation!</h4>
       <p>success, you successfully updated your notes.</p>
            </div>";
     }
    ?>

    <div class="container my-4">
      <h1 class="text-center">welcome in my crud app</h1>
      <form action="/crued_app/index.php" method="POST">
        <div class="form-group">
          <label for="title">Note title</label>
          <input
   ...
   Array.from(deletes).forEach((element)=>{
     element.addEventListener("click",(e)=>{
      ...
      if(confirm("Are you sure You want to delete!")){
        console.log("yes");
        window.location = `/crued_app/index.php?delete=${sno}`;
